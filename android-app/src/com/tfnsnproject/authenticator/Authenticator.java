...
package com.tfnsnproject.authenticator;
...
public class Authenticator extends AbstractAccountAuthenticator {
     ...
     * Account type string.
     */
    public static final String ACCOUNT_TYPE = "com.tfnsnproject.auth";

    /**
     * Authtoken type string.
     */
    public static final String AUTHTOKEN_TYPE = "com.tfnsnproject.auth";
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account,
        ...
        if (password != null) {
            final String authToken = ApiClient.getInstance().login(account.name, password);
